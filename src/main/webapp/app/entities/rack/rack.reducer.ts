...
export const ACTION_TYPES = {
  ...
  PARTIAL_UPDATE_RACK: 'rack/PARTIAL_UPDATE_RACK',
...
export default (state: RackState = initialState, action): RackState => {
  switch (action.type) {
    ...
    case REQUEST(ACTION_TYPES.PARTIAL_UPDATE_RACK):
      return {
        ...state,
        errorMessage: null,
        updateSuccess: false,
    ...
    case FAILURE(ACTION_TYPES.PARTIAL_UPDATE_RACK):
    ...
    case SUCCESS(ACTION_TYPES.PARTIAL_UPDATE_RACK):
      return {
        ...state,
        updating: false,
        updateSuccess: true,
...
export const partialUpdate: ICrudPutAction<IRack> = entity => async dispatch => {
  const result = await dispatch({
    type: ACTION_TYPES.PARTIAL_UPDATE_RACK,
