...
export const ACTION_TYPES = {
  ...
  PARTIAL_UPDATE_PUBLISHER: 'publisher/PARTIAL_UPDATE_PUBLISHER',
...
export default (state: PublisherState = initialState, action): PublisherState => {
  switch (action.type) {
    ...
    case REQUEST(ACTION_TYPES.PARTIAL_UPDATE_PUBLISHER):
      return {
        ...state,
        errorMessage: null,
        updateSuccess: false,
    ...
    case FAILURE(ACTION_TYPES.PARTIAL_UPDATE_PUBLISHER):
    ...
    case SUCCESS(ACTION_TYPES.PARTIAL_UPDATE_PUBLISHER):
      return {
        ...state,
        updating: false,
        updateSuccess: true,
...
export const partialUpdate: ICrudPutAction<IPublisher> = entity => async dispatch => {
  const result = await dispatch({
    type: ACTION_TYPES.PARTIAL_UPDATE_PUBLISHER,
