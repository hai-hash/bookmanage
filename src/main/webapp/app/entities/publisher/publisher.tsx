                ...
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>
                    {publisher.modifiedDate ? (
                      <TextFormat type="date" value={publisher.modifiedDate} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>{publisher.isActive ? 'true' : 'false'}</td>
                  <td>{publisher.user ? publisher.user.login : ''}</td>
