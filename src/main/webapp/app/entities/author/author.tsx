            ...
            <tbody>
              {authorList.map((author, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>
                    {author.modifiedDate ? <TextFormat type="date" value={author.modifiedDate} format={APP_LOCAL_DATE_FORMAT} /> : null}
                  </td>
                  <td>{author.isActive ? 'true' : 'false'}</td>
                  <td>{author.user ? author.user.login : ''}</td>
