...
/**
 * Criteria class for the {@link com.vnpt.bookmanage.domain.Author} entity. This class is used
 * in {@link com.vnpt.bookmanage.web.rest.AuthorResource} to receive all the possible filtering options from
...
public class AuthorCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, name, description, modifiedDate, isActive, userId, bookId);
    }
